...
CREATE TABLE auteurs (
    ...
    naam_auteur VARCHAR(100) NOT NULL,
    PRIMARY KEY(id)
);
CREATE TABLE posts (
    id INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO auteurs (naam_auteur)
VALUES
    ('Mounir Toub'), 
    ('Miljuschka'), 
    ('Wim Ballieu');

INSERT INTO posts (titel, datum, imglink, inhoud, auteurid, likes)
VALUES
    ...
    variatietip: Houd je van pindakaas met een smaakje? Voeg dan na de honing 1 el sambal badjak, 1 tl gemalen kaneel of 1 el fijngehakte pure chocolade toe. bewaartip: Je kunt de pindakaas 3 weken in de koelkast bewaren.', 1, 0),
    ...
    Neem de bakvorm uit de oven en verdeel de warme honing over de baklava. Garneer meteen met de rest van de fijngemalen walnoten. Laat de baklava minimaal 3 uur afkoelen voordat je ervan gaat genieten.', 3, 0);